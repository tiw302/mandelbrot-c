/* buffalo.c
 *
 * mathematical kernel for computing the buffalo fractal.
 * implements abs-based calculations in scalar, simd, and 128-bit paths.
 */
...
double buffalo_check(complex_t c, int max_iterations) {
    complex_t z = {0, 0};
    int iterations = 0;
