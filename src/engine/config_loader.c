...
int load_config_from_file(const char* filepath) {
    ...
    if (pal_count > 0 && current_default_palette >= pal_count) current_default_palette = pal_count - 1;
...
int get_config_window_width(void) { return current_window_width; }
int get_config_window_height(void) { return current_window_height; }
int get_config_default_iterations(void) { return current_default_iterations; }
int get_config_max_iterations_limit(void) { return current_max_iterations_limit; }
double get_config_escape_radius(void) { return current_escape_radius; }
int get_config_default_thread_count(void) { return current_default_thread_count; }
int get_config_default_palette(void) { return current_default_palette; }
